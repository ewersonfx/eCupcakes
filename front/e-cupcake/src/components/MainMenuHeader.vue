...
<template>
  ...
  <header class="py-3 mb-3">
    ...
    <div class="container-fluid d-grid gap-3 align-items-center mb-2" style="grid-template-columns: 0fr 3fr 0fr;">
        
        <a class="navbar-toggler" data-bs-toggle="offcanvas" href="#offcanvas">
    ...
    <div class="border-bottom">
      <div class="container mb-3">
        ...
        <div class="row align-items-center">
            ...
            <div class="dropdown col-1 px-0 d-none" style="margin-right: 20px;">
                  <a href="javascript:;" class="link-body-emphasis text-decoration-none dropdown-toggle" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  ...
                  <ul class="dropdown-menu text-small shadow">
                    <li><a class="dropdown-item" href="#">Preço - Crescente</a></li>
                    <li><a class="dropdown-item" href="#">Preço - Decrescente</a></li>
