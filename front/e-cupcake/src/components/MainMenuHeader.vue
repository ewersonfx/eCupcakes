    ...
    <div class="px-3 py-2 border-bottom mb-3">
      <div class="container d-flex flex-wrap text-center">
          ...
          <div class="row w-100">
            ...
            <div class="flex-shrink-0 dropdown col-1">
