...
<template>
  ...
  <header class="py-3 mb-3">
    ...
    <div class="container-fluid d-grid gap-3 align-items-center mb-2" style="grid-template-columns: 0fr 3fr 0fr;">
      ...
      <div class="bg-light">        
          <a href="#" class="link-body-emphasis text-decoration-none position-relative">
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" viewBox="0 0 16 16">
              <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .49.598l-1 5a.5.5 0 0 1-.465.401l-9.397.472L4.415 11H13a.5.5 0 0 1 0 1H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5M3.102 4l.84 4.479 9.144-.459L13.89 4H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4m7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4m-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2m7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2"/>
            </svg>
            <span class="position-absolute top-1 start-100 translate-middle badge rounded-pill text-primary">2</span>
          </a>         
    ...
    <div class="border-bottom">
      <div class="container mb-3">
        ...
        <div class="row align-items-center">
            ...
            <div class="dropdown col-1 px-0" style="margin-right: 20px;">
